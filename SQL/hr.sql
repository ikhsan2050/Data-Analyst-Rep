...
('NET_MAN', 'Network Manager', 50000, 70000),
...
(102, '2002-01-13', '2006-07-24', 'IT_PROG', 60),
...
(1901, NULL, 'NULL', 'Montreal', NULL, 'CA'),
(1902, NULL, 'NULL', 'Montreal', NULL, 'CA'),
(1903, NULL, 'NULL', 'Montreal', NULL, 'CA'),
...
ALTER TABLE `departments`
  ...
  ADD KEY `DEPT_LOC_FK` (`LOCATION_ID`),
...
ALTER TABLE `job_history`
  ...
  ADD KEY `JHIST_DEPT_FK` (`DEPARTMENT_ID`);
